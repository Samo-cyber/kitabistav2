                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-12">
                    ...
                    <div className="lg:col-span-4 space-y-8 text-center lg:text-right">
                        <Link href="/" className="inline-block">
                            <div className="relative h-16 md:h-20 w-48 md:w-64 mx-auto lg:mx-0">
                                <Image
                                    src="/images/logo.png"
                                    alt="كتابيستا"
                                    fill
                        ...
                        <p className="text-zinc-400 text-base md:text-lg leading-relaxed max-w-md mx-auto lg:mx-0 font-sans">
