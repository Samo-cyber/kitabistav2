                                ...
                                <Link href={`/product/${book.id}`} className="group/card block h-full">
                                    <div className="h-full bg-zinc-900/40 border border-white/10 rounded-xl overflow-hidden hover:border-primary/50 hover:bg-zinc-900/80 transition-all duration-300 flex flex-col backdrop-blur-sm group/card relative">
                                        ...
                                        <div className="p-3 pb-3 flex flex-col flex-grow relative text-center">
                                            ...
                                            <div className="w-8 h-0.5 bg-yellow-400/80 mx-auto mb-2 rounded-full transition-all duration-300 group-hover/card:w-24 group-hover/card:shadow-[0_0_12px_rgba(250,204,21,0.6)]" />
                                        ...
                                        <div className="absolute bottom-0 left-0 z-20 group/btn">
                                            <MiniAddToCartButton
                                                book={book}
                                                iconSize="w-7 h-7 animate-scale-pulse drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]"
                                                className="h-14 w-14 rounded-none rounded-tr-3xl flex items-center justify-center bg-primary/80 backdrop-blur-xl border-t border-r border-white/30 text-black shadow-[inset_0_0_20px_rgba(255,255,255,0.3)] hover:bg-primary hover:shadow-[inset_0_0_30px_rgba(255,255,255,0.5)] group-hover/btn:scale-110 transition-all duration-300 origin-bottom-left"
                                            />
                                        </div>
                                    </div>
                                </Link>
