...
import { CheckCircle, ChevronLeft, ChevronRight, CreditCard, Truck, MapPin, ShoppingBag, ShieldCheck, ArrowRight, User, Phone } from "lucide-react";
...
const formClasses = "w-full bg-black/40 border border-white/10 rounded-xl px-4 pl-10 text-white placeholder:text-gray-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all";
